...
runSolution solution = case solution of
  ...
  (7, 1) -> do
    showSolutionMetadata solution
    input <- Input.readCommaSeparatedInts "inputs/day-7.txt"
    Solutions.d7p1 input
  (7, 2) -> do
    showSolutionMetadata solution
    input <- Input.readCommaSeparatedInts "inputs/day-7.txt"
    Solutions.d7p2 input
  (8, 1) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-8.txt"
    Solutions.d8p1 input
  (8, 2) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-8.txt"
    Solutions.d8p2 input
  (9, 1) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-9.txt"
    Solutions.d9p1 input
  (9, 2) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-9.txt"
    Solutions.d9p2 input
  (10, 1) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-10.txt"
    Solutions.d10p1 input
  (10, 2) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-10.txt"
    Solutions.d10p2 input
  (11, 1) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-11.txt"
    Solutions.d11p1 input
  (11, 2) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-11.txt"
  ...
  (13, 1) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-13.txt"
    Solutions.d13p1 input
  (13, 2) -> do
    showSolutionMetadata solution
    input <- Input.readFileByLines "inputs/day-13.txt"
    Solutions.d13p2 input
